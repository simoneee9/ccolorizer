...
struct Pixel
{
      ...
      : x( x ), y( y )
  {
    ...
    // i literally worked for 8 hours today trying to make windows containers
    // work i deserve a break double x_tris = 0.4124564 * r_n + 0.3575761 * g_n
    // + 0.1804375 * b_n; double y_tris = 0.2126729 * r_n + 0.7151522 * g_n +
    // 0.0721750 * b_n; double z_tris = 0.0193339 * r_n + 0.1191920 * g_n +
    // 0.9503041 * b_n;
